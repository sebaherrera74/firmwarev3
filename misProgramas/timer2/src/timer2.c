 ...
 */
 ...
 static volatile uint32_t count=0; //volatile porque la modifico desde una interrupcion
...
int main(void)
{
	volatile uint32_t timerFreq,var=0;
	volatile int aux=0;
	...
	//Chip_TIMER_SetMatch(LPC_TIMER1, 1,10000000 );
	...
	while (1) {
		...
		//var=Chip_TIMER_ReadCount(LPC_TIMER1);
